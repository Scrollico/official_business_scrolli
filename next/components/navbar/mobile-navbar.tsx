...
export const MobileNavbar = ({
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="fixed inset-0 bg-charcoal z-50 flex flex-col items-start justify-start space-y-10  pt-5  text-xl text-zinc-600  transition duration-200 hover:text-zinc-800">
