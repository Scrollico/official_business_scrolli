    ...
    <div className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2 relative">
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-10 xl:px-14 py-6 lg:py-20 lg:flex-none mt-20">
        <div className="mx-auto w-full max-w-xl h-[calc(100vh-8rem)]">
          <div className="rounded-2xl overflow-hidden border border-borderLight bg-elevated p-2 h-full">
            <div
      ...
      <div className="relative w-full z-10 hidden md:flex border-l border-charcoal overflow-hidden bg-elevated items-center justify-center">
        <StarBackground />
        <ShootingStars />
